...
public class UCS extends Base
	{
		//No Parameter Constructor
				...
				public void run_search() throws Exception{
					System.out.println("Welcome to Uniform-Cost Search Area");
					BufferedReader bReader=new BufferedReader(new InputStreamReader(System.in));
					while(true){
						System.out.println("Please selection an option:");
						System.out.println("1: Lauch an new Uniform-Cost Search");
						...
						if(option.equals("1")){
							...
							if(validate_place(source, destination)){
								Clear_History();
								ufs_execute(source, destination);
							}
							else{
				...
				public void ufs_execute(String source,String destination) throws Exception{
