...
public class BFS extends Base
	{
		Graphics g;
		BFS(String source,String destination,JFrame main_frame,JTextArea message_display,JButton search_beginButton,JButton validate_button,MyPanel main_body,Graphics g){
			this.source=source;
		...
		public String next_step(){
				...
				System.out.println("I pop out"+expanding_node.getLocation_name());
